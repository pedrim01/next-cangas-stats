...
export function Header() {
  return (
    <header className="fixed top-0 z-40 grid w-full grid-cols-12 grid-rows-1 bg-zinc-900 p-2 text-sm/5 text-zinc-50 shadow-md shadow-zinc-700/50 sm:h-12 sm:items-center">
      ...
      <nav className="absolute top-4 mr-4 flex items-start  gap-4 justify-self-end text-3xl sm:top-2 ">
